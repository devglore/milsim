...
class Pos_Validator
{
     ...
     * @param $fieldName
     */
    public function isCorrectDate($fieldName){

        //Kolla så det är ett giltigt datum genom att dela upp datumet i 3 delar och skickar månad, dag, år till checkdate, om det är fel lägger vi till ett fel till _error arrayen
        $dateParts = preg_split ( '{[-/ :.]}', $fieldName );
